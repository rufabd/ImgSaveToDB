...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            objectImageView = findViewById(R.id.imageSelect);
    ...
    public void ChooseImage(View objectView) {
        try {
            ...
            startActivityForResult(objectIntent, PICK_IMG_REQUEST);
        }
        catch (Exception e) {
    ...
    public void storeImage(View view) {
        try {
            if(!imageDetailsET.getText().toString().isEmpty() && objectImageView.getDrawable() != null && imageToStore != null) {
                ...
                Toast.makeText(this, "Please enter image name and select image", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
            Toast.makeText(this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
