...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try{
            ...
            Toast.makeText(context, "Table has successfully been created inside our database", Toast.LENGTH_SHORT).show();
        }
        catch (Exception e) {
    ...
    public ArrayList<ModelClass> getAllImagesData() {
        try{
            ...
            if(objectCursor.getCount() != 0) {
                ...
                Toast.makeText(context, "Not any items found", Toast.LENGTH_SHORT).show();
                return null;
            }
        } catch (Exception e) {
            Toast.makeText(context, e.getMessage(), Toast.LENGTH_SHORT).show();
